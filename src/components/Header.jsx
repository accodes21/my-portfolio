...
const Header = () => {
  return (
    ...
    <motion.header {...slideAnimation('down')} className='w-full'>
        <nav className='fixed z-10 cursor-pointer flex-row items-center  overflow-hidden rounded-full border px-1 py-4 shadow-xl backdrop-blur-sm backdrop-filter border-[#f1cf29]/60 bg-black bg-opacity-60 lg:left-1/2 lg:flex lg:-translate-x-1/2 lg:transform mt-2 top-8"'>
