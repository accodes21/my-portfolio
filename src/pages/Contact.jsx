                ...
                <div className='block rounded-xl mt-[-100px] bg-[#111] shadow-xl py-10 md:py-12 px-4 md:px-6'>
                    <div>
                        <motion.form ref={form} onSubmit={sendEmail} initial='hide' whileInView='show' exit='hide' variants={...introHeaderVariants('right')}>
                            <div className='mb-6'>
                                <input type="text" className='form-control block w-full px-3 py-1.5 text-base font-normal text-zinc-200 bg-slate-800 bg-clip-padding border border-solid border-zinc-500 rounded transition ease-in-out m-0 focus:text-zinc-700 focus:bg-white focus:border-purple-600 dark:focus:border-purple-600 focus:outline-none' id='user_name' name='user_name' placeholder='Name' required autoComplete='on' />
                            </div>
                            <div className='mb-6'>
                                <input type="email" className='form-control block w-full px-3 py-1.5 text-base font-normal text-zinc-200 bg-slate-800 bg-clip-padding border border-solid border-zinc-500 rounded transition ease-in-out m-0 focus:text-zinc-700 focus:bg-white focus:border-purple-600 dark:focus:border-purple-600 focus:outline-none' id='user_email' name='user_email' placeholder='Email' required autoComplete='on' />
                            </div>
                            <div className="mb-6">
