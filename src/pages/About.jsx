...
function About() {
  return (
    <AnimatePresence>
    <motion.section id='about' className='bg-black p-36'>
        <div className="container pl-16 pr-16">
            <div className="content1 grid items-center justify-center grid-cols-2">
                <motion.div initial='hide' whileInView='show' exit='hide' variants={...introHeaderVariants('left')} className="img-side relative pr-4">
                    <Image className='rounded-3xl' width={560} height={480} src='/gif.gif' alt='Developer'/>
                </motion.div>
                <motion.div initial='hide' whileInView='show' exit='hide' variants={...introHeaderVariants('right')} className="text-side pl-4">
